...
class GameComponent {
    ...
    _startNewGame() {
        ...
        if (typeof this.myMarker === "undefined") {
            ...
            this.myMarker = game_util.getOppositeMarker(this.myMarker);
        }

        this.otherMarker = game_util.getOppositeMarker(this.myMarker);
    ...
    _buildBoard() {
        ...
        // Allocate cells.
        this.cells = game_util.createBoard(COL_COUNT, ROW_COUNT);
    }
    ...
    _placeMarker(x, y, marker) {
        if (!game_util.canPlaceMarker(x, y, this.cells)) {
            return;
        }
    ...
    _updateGameState() {
        ...
        if (this.isMyTurn) {
            ...
            if (App.inputSystem.isMouseButtonUp(App.inputSystem.MouseButton.LEFT)) {
                ...
                if (cell !== null) {
                    if (game_util.canPlaceMarker(cell.x, cell.y, this.cells)) {
            ...
            if (this.aiTurnElapsedTime >= AI_TURN_TIME) {
                ...
                let cell = Ai.getMove(boardInfo, this.otherMarker);
        ...
        if (turnFinished) {
            if (game_util.checkWin(this.cells, activeMarker)) {
            ...
            } else if (game_util.isBoardFull(this.cells)) {
